...
bool Shader::LoadVertexShader(ID3D11Device* device, const std::wstring& fileName, const std::string& entryPoint, const std::vector<D3D11_INPUT_ELEMENT_DESC>& inputElements) {
