...
void CompositePass::ExecuteAdditive(ID3D11DeviceContext *context, RenderTarget *sceneRt, RenderTarget *volumetricRt,
...
void CompositePass::ExecuteCopy(ID3D11DeviceContext *context, ID3D11RenderTargetView *destRtv,
                                ID3D11ShaderResourceView *sourceSrv, ID3D11Buffer *fullScreenVb,
